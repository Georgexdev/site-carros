...
export default function Termos() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 md:py-16">
      <h1 className="font-display text-4xl md:text-5xl leading-tight text-ink mb-3">Termos de Uso e Política de Privacidade</h1>
      <p className="text-muted mb-10">Última atualização: {new Date().toLocaleDateString("pt-BR")}</p>

      <div className="space-y-8 text-[#3D3831] leading-relaxed">
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">1. Sobre este site</h2>
          <p>
            Este site é operado por {MARCA.nome}, tendo como finalidade a divulgação de
        ...
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">2. Quais dados coletamos</h2>
        ...
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">3. Como usamos seus dados</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">4. Contato via WhatsApp</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">5. Seus direitos</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">6. Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-2xl text-ink mb-2">7. Alterações nesta política</h2>
          <p>
