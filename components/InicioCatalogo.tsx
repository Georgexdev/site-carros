...
// Parte da página inicial que roda no navegador: estoque com filtros, financiamento e venda.
// O topo (banner ou apresentação) vem pronto do servidor em app/page.tsx.
export default function InicioCatalogo() {
